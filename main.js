...
endButton.addEventListener("click", () => {
  ...
  money = 0;
  number = 0;
  document.getElementById("twentyGage").value = "0";
  document.getElementById("twoHourGage").value = "0";
  document.getElementById("eightHourGage").value = "0";
  document.getElementById("dayGage").value = "0";
  document.getElementById("twoDayGage").value = "0";
  document.getElementById("fourDayGage").value = "0";
  document.getElementById("weekGage").value = "0";
  document.getElementById("monthGage").value = "0";
  document.getElementById("threeMonthGage").value = "0";
  document.getElementById("sixMonthGage").value = "0";
  document.getElementById("yearGage").value = "0";
  document.getElementById("fiveYearGage").value = "0";
  document.getElementById("tenYearGage").value = "0";
  document.getElementById("fifteenthYearGage").value = "0";
